...
export const BASE_URL = "http://localhost:8081"; // Assuming the backend server is running on this port
...
export const uploadResume = async (resumeData) => {
    try {
        ...
        formData.append("resumeDetails", resumeData.resumeDetails);
...
export const sendToOpenAI = async (convertedText) => {
